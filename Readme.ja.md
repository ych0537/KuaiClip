...
![ライトテーマのKuaiClipクリップボード履歴](website/assets/popup-light-0.8.png)
...
- 🎨 **6つのカラーテーマ** — ホワイト、スカイ、ミント、サンド、ラベンダー、ダークをポップアップから切替可能
...
- 🔤 **ローカル画像OCR** — コピーした画像からApple Visionで端末内処理のまま文字を抽出
...
![注釈ツールを備えたKuaiClip 0.8スクリーンショットエディタ](docs/images/screenshot-editor-0.8.png)
